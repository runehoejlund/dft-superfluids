...
#SBATCH --output=n-H-CrS2_p-H-CrSe2_analytic_MF/out.txt #name
#SBATCH --error=n-H-CrS2_p-H-CrSe2_analytic_MF/err.txt  #name

module purge
module add intel

~/bin/BiEx/biex/BiEx n-H-CrS2_p-H-CrSe2_analytic_MF.inp
