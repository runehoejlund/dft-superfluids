...
#SBATCH --output=n-H-CrSe2_p-H-CrO2_QEH_MF/out.txt #name
#SBATCH --error=n-H-CrSe2_p-H-CrO2_QEH_MF/err.txt  #name

module purge
module add intel

~/bin/BiEx/biex/BiEx n-H-CrSe2_p-H-CrO2_QEH_MF.inp
