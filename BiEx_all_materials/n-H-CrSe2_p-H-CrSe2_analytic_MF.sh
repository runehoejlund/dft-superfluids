...
#SBATCH --output=n-H-CrSe2_p-H-CrSe2_analytic_MF/out.txt #name
#SBATCH --error=n-H-CrSe2_p-H-CrSe2_analytic_MF/err.txt  #name

module purge
module add intel

~/bin/BiEx/biex/BiEx n-H-CrSe2_p-H-CrSe2_analytic_MF.inp
