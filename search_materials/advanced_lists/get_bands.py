...
np.savez('./so_split_extremum-loc.npz',UID_vec=UID_vec,Material_plot=Material_plot,bandgap_vec=bandgap_vec, formula_cond=formula_cond,uid_cond=uid_cond,split_cond_vec=split_cond_vec,split2_cond_vec=split2_cond_vec,loc_cond_vec=loc_cond_vec,formula_val=formula_val,uid_val=uid_val,split_val_vec=split_val_vec,split2_val_vec=split2_val_vec,loc_val_vec=loc_val_vec,bandgap_db=bandgap_db,dir_bandgap_db=dir_bandgap_db)