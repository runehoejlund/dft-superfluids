...
def calculate_groundstate(formula, ecut = 800, no_kpts=30, vac=20, xc='PBE', T_e=0.01, nbands = 504):
    ...
    out_dir = './out/'
    file_prefix = out_dir + formula + '_'+xc+'_ecut_{}_kp_{}'.format(ecut,no_kpts)
    ...
    calc.write(file_prefix + '_gs_rec_latt.gpw')
