...
for i in range(len(formula_List)):
    ...
    name = out_dir + formula + '_'+xc+'_ecut_{}_kp_{}'.format(ecut,no_kpts)+ '_gs.gpw'
    ...
    bs.write('bsLoop_formula_'+formula+'_direction_'+sym_path+'_npoints_{}_emptybands_{}'.format(nP,emptybands)+ '_'+xc+'_ecut_{}_kp_{}'.format(ecut,no_kpts)+'.json')