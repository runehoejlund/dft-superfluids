...
Materials = []
for (dirpath, dirnames, filenames) in walk('./materials-data'):
    N=len('-chi.npz')
...
np.savez('./01_materials_stable.npz',Material_plot=Material_plot,bandgap=bandgap_vec,dir_bandgap=dir_bandgap_vec,material_c2db_list=Material_c2db,emass1_vec=emass1_vec,emass2_vec=emass2_vec,hmass1_vec=hmass1_vec,hmass2_vec=hmass2_vec,uid_vec=uid_vec,thermo_stab=thermo_stab,ehull_vec=ehull_vec)
